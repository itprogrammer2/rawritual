...
<section>
	<div class="mini-posts">
		<article>
			<center><a style="border-bottom: none;" href="../"><img style="max-width: 150px;" src="<?php echo $logo?>" alt="" /></a>
			<p>dashboard</p>
			</center>
	...
	<ul>
		<li><a style="border-bottom: none;" href="index.php" <?php if($basename == "index.php"){ echo "class='active_menu'"; }?>>Accessibility</a></li>
		<li>
		...
		<li>
			<span class="opener <?php if($basename == "icon.php" || $basename == "image.php" || $basename == "about.php"){ echo "active_menu"; }?>" >CMS</span>
			<ul>
				<li><a href="icon.php" <?php if($basename == "icon.php"){ echo "class='active_menu'"; }?>>Icon</a></li>
